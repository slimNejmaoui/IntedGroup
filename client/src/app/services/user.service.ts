...
export class UserService {
    ...
    getUserImage(fileName: string): Observable<any> {
        const headers = new HttpHeaders().set('Authorization', this.getToken());
        return this._http.get(`${this.url}get-image-user/${fileName}`, { headers: headers, responseType: 'blob' });
    }

    getImage(userId: string): Observable<any> {
        let headers = new HttpHeaders().set('Authorization', this.getToken());
        return this._http.get(`${this.url}get-image-user/${userId}`, { headers: headers, responseType: 'blob' });
    }
